...
<nav id="site-nav">
      ...
      <ul class="nav-links">
        ...
        <li class="nav-dropdown">
          ...
          <div class="nav-dropdown-menu">
            ...
            <a href="tds-section-master.html"><span class="act-dot" style="background:#1A3A6B"></span>TDS/TCS Section Master</a>
          </div>
        </li>
  ...
  <div class="mobile-menu" id="mobile-menu">
    ...
    <a href="tds-section-master.html">✂️ TDS/TCS Section Master</a>
  ...
  <div class="container">
    <div class="footer-grid">
      <div class="footer-brand">
        ...
        <p>India's AI-powered platform for Indian statutory law — Income Tax, GST, Companies Act, FEMA, Labour Laws, SEBI & IBC. Powered by Evenset Consultancy Services.</p>
        <div class="footer-social" style="margin-top:16px">
          ...
          <a href="https://evensetconsultancy.com" target="_blank">🌐</a>
        </div>
      </div>
      <div class="footer-col">
        ...
        <ul>
          ...
          <li><a href="tds-section-master.html">TDS/TCS Master</a></li>
        </ul>
      </div>
      <div class="footer-col">
        <h4>Quick Links</h4>
        <ul>
          ...
          <li><a href="https://www.incometaxindia.gov.in" target="_blank">Income Tax Portal</a></li>
          <li><a href="https://services.gst.gov.in" target="_blank">GST Portal</a></li>
          <li><a href="https://www.mca.gov.in" target="_blank">MCA Portal</a></li>
        </ul>
      </div>
      <div class="footer-col">
        <h4>Weekly Updates</h4>
        <p style="font-size:0.85rem;margin-bottom:4px">Tax circulars, compliance alerts & law updates from TrustFactON.</p>
...
function showToast(msg, type = 'info') {
  const bg = type === 'error' ? '#DC2626' : '#1A3A6B';
  const t = document.createElement('div');
  t.style.cssText = `position:fixed;bottom:24px;right:24px;background:${bg};color:white;padding:12px 20px;border-radius:10px;font-size:0.88rem;font-family:'DM Sans',sans-serif;z-index:9999;box-shadow:0 8px 24px rgba(0,0,0,0.2);animation:slideUp 0.3s ease`;
  t.textContent = msg;
...
function showTopic(val) {
  ...
  if (panel) {
    ...
    document.getElementById('panels-wrap')?.scrollIntoView({behavior:'smooth', block:'start'});
  }
  const sel = document.getElementById('topicSelect');
  if (sel) sel.value = val;
  document.querySelectorAll('.topic-chip').forEach(c => {
    c.classList.toggle('active', c.getAttribute('onclick') === `showTopic('${val}')`);
  });
}
